...
<body>
    ...
    <div class="about">
        <p class="aboutph">About Us</caption>
        <p class="aboutpt">We are helping those covid affected families who needs Oxygen cylinders to survive. This is the website to show infromational details.</p>
    </div>
